    ...
    execute: (row) =>
      sql`
        INSERT INTO projection_threads (
          ...
          branch,
          worktree_path,
          fork_imported_source,
          fork_imported_session_id,
          latest_turn_id,
          created_at,
          updated_at,
          archived_at,
        ...
        DO UPDATE SET
          ...
          fork_imported_source = excluded.fork_imported_source,
          fork_imported_session_id = excluded.fork_imported_session_id,
    ...
    execute: ({ threadId }) =>
      sql`
        SELECT
          ...
          fork_imported_source AS "importedSource",
          fork_imported_session_id AS "importedSessionId",
